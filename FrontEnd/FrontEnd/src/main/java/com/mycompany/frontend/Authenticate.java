...
public class Authenticate {
    ...
    public Authenticate() {
        ...
        secretString = Encoders.BASE64.encode("mysecuresecurecode_coe692_labs_winter2021 new String is for the course mysecuresecurecode_coe692_labs_winter2021 new String is for the course".getBytes());

    }

    public String createJWT(String issuer, String subject, long ttlMillis) throws UnsupportedEncodingException {
        ...
        builder = Jwts.builder()
                ...
                .setIssuer(issuer)
                .signWith(signingKey)
                .signWith(Keys.hmacShaKeyFor(secretString.getBytes("UTF-8")), signatureAlgorithm);
    ...
    public Entry<Boolean, String> verify(String jwt) throws UnsupportedEncodingException {
        ...
        try {
            jws = Jwts.parserBuilder() // (1)
                    .setSigningKey(Keys.hmacShaKeyFor(secretString.getBytes("UTF-8"))) // (2)
                    .build() // (3)
